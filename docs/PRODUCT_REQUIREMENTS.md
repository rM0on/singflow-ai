...
| Scene input | User can submit a natural language scene prompt | Planner can call the local mock playlist generation workflow with `mode=mock` and keep a mock fallback |
